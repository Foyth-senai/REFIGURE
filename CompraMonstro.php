...
<div id="produtinho class="container-fluid">
    ...
    <div class="slideshow-container mt-5 ms-4">
        ...
        <div class="mySlides fade">
          <img src="imagem/Monstro Larry.png" style="width:100%; height:100%;">
        </div>
        <div class="mySlides fade">
          <img src="imagem/sapo 3.png" style="width:100%; height:100%">
        </div>
        <div class="mySlides fade">
          <img src="imagem/sapo 4.png" style="width:100%; height:100%">
        </div>
      ...
      <div style="text-align:center">
        ...
        <div class="nomee"><b>Monstro Larry</b></div>
        <div class="descricao">
            <ul>
        ...
        <form action="CompraMonstro.php" method="post">
        <input placeholder="Quantidade" value="1" name="quantidade" class="input-style" type="number" min="1" max="100">
        <div class="compr">
            <div class="precoo">
                <div class="avista"><ion-icon name="cash-outline"></ion-icon><div class="formatarvalor"><h1>a partir de</h1><h2>R$130,00</h2><br><h3>a vista 10% de desconto</h3></div></div>
                <div class="parcelado"><ion-icon name="card-outline"></ion-icon><div class="formatarvalor"><h4>R$143,00</h4><br><h5>em até 6x de R$ 23,83 sem juros no cartão</h5></div></div>
            </div>
        <div class="comp">
        ...
        <?php
            ...
            if(isset($_POST["comprar"]) )
            {
                ...
                $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, qtd_produto='$quantidade' WHERE id_produto = 14;");
                $resultado = $comando->execute();
