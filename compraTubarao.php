...
<div id="produtinho class="container-fluid">
    ...
    <div class="slideshow-container mt-5 ms-4">
        ...
        <div class="mySlides fade">
          <img src="imagem/tutuba.png" style="width:100%; height:100%;">
        </div>
        <div class="mySlides fade">
          <img src="imagem/tutuba 2.png" style="width:100%; height:100%">
        </div>
        <div class="mySlides fade">
          <img src="imagem/tutuba 3.png" style="width:100%; height:100%">
        </div>
      ...
      <div style="text-align:center">
        ...
        <div class="nomee"><b>Tutubarão</b></div>
        <div class="descricao">
            <ul>
        ...
        <form action="CompraTubarao.php" method="post">
        ...
        <?php
            ...
            if(isset($_POST["comprar"]) )
            {
                ...
                $comando = $pdo->prepare("UPDATE produtos SET carrinho=1, qtd_produto='$quantidade' WHERE id_produto = 11;");
                $resultado = $comando->execute();
